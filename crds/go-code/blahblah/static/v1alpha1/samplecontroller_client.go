...
func (c *SamplecontrollerV1alpha1Client) Blahs(namespace string) BlahInterface {
	return newBlahs(c, namespace)
}

// NewForConfig creates a new SamplecontrollerV1alpha1Client for the given config.
func NewForConfig2(c *rest.Config) (*SamplecontrollerV1alpha1Client, error) {
	config := *c
...
func NewForConfigOrDie2(c *rest.Config) *SamplecontrollerV1alpha1Client {
